...
max_magnitude = 0
all_line_combinations = []
for line1 in array:
    for line2 in array:
        all_line_combinations.append(add_lines(line1,line2))

for line in all_line_combinations:
    while True:
        ...
        if ce:
            ...
            if cs:  
                ...
                max_magnitude = max(max_magnitude, calculate_magnitude(line))
                break
